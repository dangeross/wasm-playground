...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::Network)]
pub enum Network {
    Bitcoin,
    Testnet,
    Signet,
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::ExternalInputParser)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::LNInvoice)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::RouteHintHop)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::Amount)]
pub enum Amount {
    Bitcoin {
        amount_msat: u64,
    },
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::LnOfferBlindedPath)]
pub struct LnOfferBlindedPath {
    pub blinded_hops: Vec<String>,
}

#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::LNOffer)]
pub struct LNOffer {
    pub offer: String,
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::InputType)]
pub enum InputType {
    BitcoinAddress {
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::BitcoinAddressData)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::LiquidAddressData)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::LnUrlPayRequestData)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::SuccessAction)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::SuccessActionProcessed)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::AesSuccessActionData)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::AesSuccessActionDataResult)]
pub enum AesSuccessActionDataResult {
    Decrypted { data: AesSuccessActionDataDecrypted },
    ErrorStatus { reason: String },
}

#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::AesSuccessActionDataDecrypted)]
pub struct AesSuccessActionDataDecrypted {
    pub description: String,
    pub plaintext: String,
}

#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::MessageSuccessActionData)]
pub struct MessageSuccessActionData {
    pub message: String,
}

#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::UrlSuccessActionData)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::LnUrlPayErrorData)]
pub struct LnUrlPayErrorData {
    pub payment_hash: String,
    pub reason: String,
}

#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::LnUrlWithdrawRequestData)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::LnUrlAuthRequestData)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::LnUrlWithdrawRequest)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::Rate)]
pub struct Rate {
    pub coin: String,
    pub value: f64,
}

#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::FiatCurrency)]
pub struct FiatCurrency {
    pub id: String,
    pub info: CurrencyInfo,
}

#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::CurrencyInfo)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::LocaleOverrides)]
...
#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::LocalizedName)]
pub struct LocalizedName {
    pub locale: String,
    pub name: String,
}

#[sdk_macros::extern_wasm_bindgen(sdk_common::prelude::Symbol)]
pub struct Symbol {
